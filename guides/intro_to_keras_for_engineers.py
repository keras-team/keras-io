...
- `tf.keras.preprocessing.image_dataset.image_dataset_from_directory` turns image files sorted into
 class-specific folders into a labeled dataset of image tensors.
- `tf.keras.preprocessing.text_dataset.text_dataset_from_directory` does the same for text files.
...
```python
dataset = keras.preprocessing.text_dataset.text_dataset_from_directory(
