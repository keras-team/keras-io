...
- [Guide to the Functional API](https://github.com/keras-team/keras-io/blob/master/guides/functional_api.py)
- [Guide to making new Layers & Models via subclassing](https://github.com/keras-team/keras-io/blob/master/guides/making_new_layers_and_models_via_subclassing.py)
