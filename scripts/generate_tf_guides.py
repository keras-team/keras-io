...
TF_BUTTONS_TEMPLATE = {
    ...
    "source": [
        ...
        "  </td>\n",
        "  <td>\n",
        '    <a href="https://github.com/keras-team/keras-io/blob/master/tf/TARGET_NAME.ipynb"><img src="https://www.tensorflow.org/images/download_logo_32px.png" />Download notebook</a>\n',
        "  </td>\n",
        "</table>",
    ],
}
