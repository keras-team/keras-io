    ...
    "children": [
        {
            ...
            "generate": [
                ...
                "tensorflow.keras.layers.Layer.build",
                "tensorflow.keras.layers.Layer.call",
                "tensorflow.keras.layers.Layer.compute_mask",
                "tensorflow.keras.layers.Layer.compute_output_shape",
                "tensorflow.keras.layers.Layer.compute_output_signature",
                "tensorflow.keras.layers.Layer.count_params",
                "tensorflow.keras.layers.Layer.from_config",
                ...
                "tensorflow.keras.layers.Layer.__call__",
            ],
        },
        {
            "path": "activations",
