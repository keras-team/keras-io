...
for n in [7, 14, 28]:
    ...
    tmp_features.append(
        ...
        .simple_moving_average(
            tp.duration.days(n), sampling=transactions_per_terminal
        )
...
For the example to run faster, we will effectively reduce the size of the training set to:
...
begin_train = datetime.datetime(
    2018, 7, 1
).timestamp()  # Reduced training dataset
