...
Description: An implementation of Graph Attention Networks (GAT) for node classification.
"""
"""
## Introduction
...
The results look pretty good! The GAT model seems to correctly predict the subjects of the papers,
