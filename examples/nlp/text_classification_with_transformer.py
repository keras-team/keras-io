...
Author: [Apoorv Nandan](https://twitter.com/NandanApoorv) and [Khalid Salama](https://www.linkedin.com/in/khalid-salama-24403144/)
...
This example demonstrates the implementation of the standard
[Transformer](https://arxiv.org/abs/1706.03762) and the
[Switch Transformer](https://arxiv.org/abs/2101.03961) models for text
classification.
...
ff_dim = 32  # Hidden layer size in feedforward network inside the Transformer.
...
This is used in a single instance in the standard Transformer block,
or as a Mixture of Experts in the Switch Transformer.
"""
...
def create_classifier(transformer_model):
    inputs = transformer_model.inputs
    x = transformer_model.outputs[0]
...
"""
## Experiment 1: standard Transformer
"""
...
def create_standard_transformer():
    ffn = create_feedforward_network(ff_dim)
    inputs = layers.Input(shape=(num_tokens_per_example,))
    embedding_layer = TokenAndPositionEmbedding(
        num_tokens_per_example, vocab_size, embed_dim
    )
    x = embedding_layer(inputs)
    transformer_block = TransformerBlock(embed_dim, num_heads, ffn)
...
standard_transformer = create_standard_transformer()
standard_transformer.summary()

classifier = create_classifier(standard_transformer)
run_experiment(classifier)

"""
## Experiment 2: Switch Transformer
"""
...
"""
### Implement a Switch Transformer block as a layer
"""
...
"""
### Create a Switch Transformer model
"""
...
classifier = create_classifier(switch_transformer)
run_experiment(classifier)
