...
# Testing Pipeline
pipeline_test = (
    val_ds.map(preprocess_test, num_parallel_calls=1).batch(BATCH_SIZE).prefetch(2)
)
...
lr_schedule = tf.keras.optimizers.schedules.PiecewiseConstantDecay(
    boundaries=SCHEDULE_BOUNDARIES, values=[lr, lr * 0.1, lr * 0.01, lr * 0.001]
)
...
"""
In this example, we trained our model for 5 epochs. In our experiment, the BigTransfer(BiT) Model performs amazing by giving us a good validation accuracy.
