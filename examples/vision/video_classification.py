...
You can use the trained model hosted on [Hugging Face Hub](https://huggingface.co/keras-io/video-classification-cnn-rnn) and try the demo on
[Hugging Face Spaces](https://huggingface.co/spaces/keras-io/keras-video-classification-cnn-rnn).
"""
