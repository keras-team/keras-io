# Two-Stage Instance Segmentation with RetinaNet and SAM

**Author:** [Abdulrahim Kasim](https://www.linkedin.com/in/kasim-abdulrahim/0<br>
**Date created:** 2026/08/29<br>
**Last modified:** 2026/08/29<br>
**Description:** Two-stage instance segmentation assembled entirely from pretrained KerasHub.


<img class="k-inline-icon" src="https://colab.research.google.com/img/colab_favicon.ico"/> [**View in Colab**](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/two_stage_instance_segmentation.ipynb)  <span class="k-dot">•</span><img class="k-inline-icon" src="https://github.com/favicon.ico"/> [**GitHub source**](https://github.com/keras-team/keras-io/blob/master/examples/vision/two_stage_instance_segmentation.py)
...
- [Grounded-DINO + Meta AI's SAM = Instance
Segmentation](https://medium.com/@amir_shakiba/grounded-dino-meta-ais-sam-instance-segmentation-386240de4825)
Segmentation](https://medium.com/@amir_shakiba/grounded-dino-meta-ais-sam-instance-segmentation-386240de4825)
- [Segment Anything in
...
```
Downloading data from https://deeplearningwithpython.io/images/ch11/fruits.8cef44dc.png

1525965/1525965 ━━━━━━━━━━━━━━━━━━━━ 0s 0us/step

Image: (1440, 1920, 3)

1/1 ━━━━━━━━━━━━━━━━━━━━ 26s 26s/step

{'boxes': (1, 100, 4), 'confidence': (1, 100), 'labels': (1, 100), 'num_detections': (1,)}
num_detections: 6
Top-6 labels: ['banana', 'banana', 'apple', 'bowl', 'apple', 'apple']
Top-6 scores: [0.898 0.833 0.832 0.789 0.717 0.604]
```
</div>
...
![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_7_0.png)
...
def plot_mask(image, boxes, names, masks):
    """Plot each mask individually with its corresponding box and label"""
...
Detected 6 above 0.35 confidence threshold.
  banana: 0.898
  banana: 0.833
  apple: 0.832
  bowl: 0.789
...
1/1 ━━━━━━━━━━━━━━━━━━━━ 2s 2s/step
  ...
  banana: 0.898, IoU: 0.989
  banana: 0.833, IoU: 0.968
  apple: 0.832, IoU: 0.998
  bowl: 0.789, IoU: 0.986
  apple: 0.717, IoU: 1.007
  apple: 0.604, IoU: 0.978
```
</div>

![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_11_16.png)
    



    
![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_11_17.png)
    



    
![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_11_18.png)
    



    
![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_11_19.png)
    



    
![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_11_20.png)
    



    
![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_11_21.png)
    



    
![png](/img/examples/vision/two_stage_instance_segmentation/two_stage_instance_segmentation_11_22.png)
