...
/Users/adonaivera/Documents/keras-io/env/lib/python3.11/site-packages/keras/src/models/functional.py:104: UserWarning: When providing `inputs` as a dict, all keys in the dict must match the names of the corresponding tensors. Received key 'latent_array' mapping to value <KerasTensor shape=(None, 256, 256), dtype=float32, sparse=None, name=keras_tensor> which has name 'keras_tensor'. Change the tensor name to 'latent_array' (via `Input(..., name='latent_array')`)
  warnings.warn(
/Users/adonaivera/Documents/keras-io/env/lib/python3.11/site-packages/keras/src/models/functional.py:104: UserWarning: When providing `inputs` as a dict, all keys in the dict must match the names of the corresponding tensors. Received key 'data_array' mapping to value <KerasTensor shape=(None, 1024, 256), dtype=float32, sparse=None, name=keras_tensor_1> which has name 'keras_tensor_1'. Change the tensor name to 'data_array' (via `Input(..., name='data_array')`)
  warnings.warn(

 704/704 ━━━━━━━━━━━━━━━━━━━━ 9844s 14s/step - acc: 0.0099 - loss: 4.6902 - top5-acc: 0.0522 - val_acc: 0.0080 - val_loss: 4.6066 - val_top5-acc: 0.0410 - learning_rate: 0.0010
Epoch 2/2
 704/704 ━━━━━━━━━━━━━━━━━━━━ 9599s 14s/step - acc: 0.0093 - loss: 4.6056 - top5-acc: 0.0479 - val_acc: 0.0076 - val_loss: 4.6069 - val_top5-acc: 0.0408 - learning_rate: 0.0010
 313/313 ━━━━━━━━━━━━━━━━━━━━ 630s 2s/step - acc: 0.0098 - loss: 4.6053 - top5-acc: 0.0500
Test accuracy: 1.0%
