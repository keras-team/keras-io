...
To: /content/keras-io/scripts/tmp_9102313/instance-level-human-parsing.zip
2.91GB [00:30, 95.4MB/s]
...
__________________________________________________________________________________________________
average_pooling2d (AveragePooli (None, 1, 1, 64)     0           conv2_block3_2_relu[0][0]        
__________________________________________________________________________________________________
conv2d (Conv2D)                 (None, 1, 1, 256)    16640       average_pooling2d[0][0]          
__________________________________________________________________________________________________
batch_normalization (BatchNorma (None, 1, 1, 256)    1024        conv2d[0][0]                     
__________________________________________________________________________________________________
conv2d_1 (Conv2D)               (None, 128, 128, 256 16384       conv2_block3_2_relu[0][0]        
__________________________________________________________________________________________________
conv2d_2 (Conv2D)               (None, 128, 128, 256 147456      conv2_block3_2_relu[0][0]        
__________________________________________________________________________________________________
conv2d_3 (Conv2D)               (None, 128, 128, 256 147456      conv2_block3_2_relu[0][0]        
__________________________________________________________________________________________________
conv2d_4 (Conv2D)               (None, 128, 128, 256 147456      conv2_block3_2_relu[0][0]        
__________________________________________________________________________________________________
...
__________________________________________________________________________________________________
up_sampling2d (UpSampling2D)    (None, 128, 128, 256 0           tf.nn.relu[0][0]                 
__________________________________________________________________________________________________
tf.nn.relu_1 (TFOpLambda)       (None, 128, 128, 256 0           batch_normalization_1[0][0]      
__________________________________________________________________________________________________
tf.nn.relu_2 (TFOpLambda)       (None, 128, 128, 256 0           batch_normalization_2[0][0]      
__________________________________________________________________________________________________
tf.nn.relu_3 (TFOpLambda)       (None, 128, 128, 256 0           batch_normalization_3[0][0]      
__________________________________________________________________________________________________
tf.nn.relu_4 (TFOpLambda)       (None, 128, 128, 256 0           batch_normalization_4[0][0]      
__________________________________________________________________________________________________
concatenate (Concatenate)       (None, 128, 128, 128 0           up_sampling2d[0][0]              
                                                                 tf.nn.relu_1[0][0]               
                                                                 tf.nn.relu_2[0][0]               
                                                                 tf.nn.relu_3[0][0]               
                                                                 tf.nn.relu_4[0][0]               
__________________________________________________________________________________________________
conv2d_5 (Conv2D)               (None, 128, 128, 256 327680      concatenate[0][0]                
__________________________________________________________________________________________________
...
==================================================================================================
Total params: 2,322,004
Trainable params: 2,315,380
...
```
Epoch 1/25
50/50 [==============================] - 39s 343ms/step - loss: 1.9152 - accuracy: 0.5077
Epoch 2/25
50/50 [==============================] - 17s 348ms/step - loss: 1.2517 - accuracy: 0.6220
Epoch 3/25
50/50 [==============================] - 18s 355ms/step - loss: 1.1626 - accuracy: 0.6413
Epoch 4/25
50/50 [==============================] - 18s 364ms/step - loss: 1.0790 - accuracy: 0.6620
Epoch 5/25
50/50 [==============================] - 19s 372ms/step - loss: 1.0240 - accuracy: 0.6783
Epoch 6/25
50/50 [==============================] - 19s 382ms/step - loss: 1.0055 - accuracy: 0.6804
Epoch 7/25
50/50 [==============================] - 19s 372ms/step - loss: 0.9675 - accuracy: 0.6903
Epoch 8/25
50/50 [==============================] - 18s 368ms/step - loss: 0.9213 - accuracy: 0.7053
Epoch 9/25
50/50 [==============================] - 19s 371ms/step - loss: 0.8636 - accuracy: 0.7229
Epoch 10/25
50/50 [==============================] - 19s 372ms/step - loss: 0.8139 - accuracy: 0.7374
Epoch 11/25
50/50 [==============================] - 19s 370ms/step - loss: 0.7621 - accuracy: 0.7573
Epoch 12/25
50/50 [==============================] - 18s 367ms/step - loss: 0.7277 - accuracy: 0.7663
Epoch 13/25
50/50 [==============================] - 19s 369ms/step - loss: 0.7325 - accuracy: 0.7646
Epoch 14/25
50/50 [==============================] - 19s 370ms/step - loss: 0.6765 - accuracy: 0.7848
Epoch 15/25
50/50 [==============================] - 19s 371ms/step - loss: 0.6545 - accuracy: 0.7929
Epoch 16/25
50/50 [==============================] - 19s 372ms/step - loss: 0.6150 - accuracy: 0.8078
Epoch 17/25
50/50 [==============================] - 19s 369ms/step - loss: 0.5622 - accuracy: 0.8222
Epoch 18/25
50/50 [==============================] - 19s 371ms/step - loss: 0.5516 - accuracy: 0.8246
Epoch 19/25
50/50 [==============================] - 19s 372ms/step - loss: 0.5310 - accuracy: 0.8325
Epoch 20/25
50/50 [==============================] - 19s 372ms/step - loss: 0.5168 - accuracy: 0.8365
Epoch 21/25
50/50 [==============================] - 19s 370ms/step - loss: 0.4588 - accuracy: 0.8581
Epoch 22/25
50/50 [==============================] - 19s 369ms/step - loss: 0.4306 - accuracy: 0.8689
Epoch 23/25
50/50 [==============================] - 19s 369ms/step - loss: 0.4029 - accuracy: 0.8777
Epoch 24/25
50/50 [==============================] - 19s 372ms/step - loss: 0.3919 - accuracy: 0.8804
Epoch 25/25
50/50 [==============================] - 19s 372ms/step - loss: 0.3806 - accuracy: 0.8835
