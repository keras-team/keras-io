...
performs better with `CutMix Augmentation` with a better accuracy (for example 77.15% in
one experiment) compared to model with a accuracy (for example 71.06%).
